...
Namespace HSP.Data
    Public Class Lokasi
        Public Enum enumLokasiProduksi
            GudangInduk = 100
            GudangPulosari = 101
            FloorExtruder = 510
            GudangBenang = 511
    ...
    Public Class _DaftarLokasi : Implements IDataLookup
        ...
        Public Function GetLokasiProduksi(ByVal LokasiProduksi As UnitProduksi.enumKelompokProduksi) As UnitProduksi
            Dim SQL As String

            SQL = "SELECT * FROM tlokasi " +
                  "WHERE KodeLokasi = @KelompokProduksi LIMIT 1"

            Using DBX As IDbConnection = _DBConnection.Connection
                GetLokasiProduksi = DBX.Query(Of UnitProduksi)(SQL, New With {.LokasiProduksi = LokasiProduksi}).FirstOrDefault
            End Using
        End Function
    End Class
End Namespace
