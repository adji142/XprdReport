Public Class Form1
    ...
    Private Sub LapMonitoringMesinToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapMonitoringMesinToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT_MonitoringMesinPPIC
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub MonitoringWOListToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MonitoringWOListToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT7000_Monitoring_WO_ListPPIC
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub AnalisaExtruderToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaExtruderToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT100_140_Extruder
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LaporanBackorder1ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LaporanBackorder1ToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTPPIC_Backorder_1
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub ListBOMWOToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ListBOMWOToolStripMenuItem.Click
        Dim ifrmChild As New frmListBomWO
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapVarianceToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapVarianceToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT800_150_CostAccounting
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapWIPToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapWIPToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT800_150_CostAccountingWIP
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub AnalisaRollToRollLaminasiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaRollToRollLaminasiToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT310_130_Laminating_AnalisaRollKeRoll
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub AnalisaRollToRollPrintingToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaRollToRollPrintingToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT320_130_PrintingRoll_AnalisaRollKeRoll
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub AnalisaRollToPcsCuttingToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaRollToPcsCuttingToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT321_121_Cutting_AnalisaRollKePcs
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub ReturHasilToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ReturHasilToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT410_100_ReturHasilProduksi_
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub PeformaPenyerahanHasilToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PeformaPenyerahanHasilToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT400_200_PenyerahanHasilProduksi
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapAnalisaWOCostAccToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapAnalisaWOCostAccToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT800_120_CostAccounting
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapAnalisaWOCostAccPeriodicToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapAnalisaWOCostAccPeriodicToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT800_121_CostAccounting
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapPerhitunganHargaPokokToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapPerhitunganHargaPokokToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTHPPCostAcoounting
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapStockBMFToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapStockBMFToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT500_130_StockHasilBenangMultifilament
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapStockBMFFloorBMFToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapStockBMFFloorBMFToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT500_130_StockHasilBenangMultifilament_FloorBMF
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub GrafikExtruderToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GrafikExtruderToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT1300_Extruder
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub GrafikBMFToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles GrafikBMFToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT1300_BMF
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub R319110LapStockBallpressCementBagToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles R319110LapStockBallpressCementBagToolStripMenuItem.Click

    End Sub

    Private Sub LapPemakaianBahanInnerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapPemakaianBahanInnerToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTPemakaianBahanInner
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapGrafikRecoToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapGrafikRecoToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT1300_Recycle
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LaporanMonitoringHasilProduksiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LaporanMonitoringHasilProduksiToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTPPIC_MonitoringOP
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapReturBenangToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapReturBenangToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT110_100_GudangBenang_Ret
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LaporanSinkronisasiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LaporanSinkronisasiToolStripMenuItem.Click
        Dim ifrmChild As New frmRPT_Sinkronisasi
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapTransformBenangToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapTransformBenangToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTTransformBenang
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub AnalisaRollToPcsCBToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaRollToPcsCBToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTAnalisaRolltoPCSCemmentBag
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub R319100LapHasilBallpressCementBagToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles R319100LapHasilBallpressCementBagToolStripMenuItem.Click

    End Sub

    Private Sub AnalisaAfvalVsBSToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnalisaAfvalVsBSToolStripMenuItem.Click
        Dim ifrmChild As New FrmRpt_BSvsAfval
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
    ...
    Private Sub LapKartuStockSupportPPICToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LapKartuStockSupportPPICToolStripMenuItem.Click
        Dim ifrmChild As New frmRPTKartuStockSupportPPIC
        IsMdiContainer = True
        ifrmChild.MdiParent = Me
        'frmformDO.Dock = DockStyle.Fill
        ifrmChild.Show()
