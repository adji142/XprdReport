...
Public Class SAPInventory : Implements IDataLookup
    ...
    Public Function FindItemSlitting(ByVal KodeItem As String) As ItemSAP
        ...
        End Using
    End Function
    Public Function ReadMasterItem(ROUTING As String)
        Dim DB As New SAPDBConnection
        Dim SQL As String
        ...
        SQL = "SELECT " +
              ...
              "     ""U_SOL_ROUTING"" As U_SOL_ROUTING, " +
              "     CASE WHEN CAST(U_SOL_ADS_PNJNGKRNG AS VARCHAR) = '*' THEN CAST('0' AS DOUBLE) ELSE U_SOL_ADS_PNJNGKRNG END As PjgStandar, " +
              "     ""U_SOL_SATUAN_GRM"" As BeratSTD " +
              "FROM ""OITM"" WHERE U_SOL_ROUTING = '" + ROUTING + "'"
