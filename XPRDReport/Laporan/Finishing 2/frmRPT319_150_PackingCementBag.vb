...
Public Class frmRPT319_150_PackingCementBag
    ...
    Private Sub FillCombo()
        ...
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.CuttingCB)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt319151_PenyelesaianWO_PackingCementBag.RPT")
        End Select
