...
Public Class frmRPT312_120_BahanRollCementBag
    ...
    Private Sub FillCombo()
        ...
        Dim DSX As DataSet
        DSX = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.CuttingCB)

        If DSX.Tables(0).Rows.Count > 0 Then
            KodeUnit = DSX.Tables(0).Rows(0).Item("Kode")
        End If

        DS = DaftarMesinProduksi.Read("%", KodeUnit)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT312121_BahanRollCementBag.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT312122_BahanRollCementBag.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT312123_BahanRollCementBag.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT312124_BahanRollCementBag.RPT")
        End Select
