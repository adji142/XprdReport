...
Public Class frmRPT311_110_StockRollSlitting
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim DS As DataSet
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.SlittingCB)
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT311111_StockRollSlitting.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT311112_StockRollSlitting.RPT")
        End Select
