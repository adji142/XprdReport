...
Public Class frmRPT310_130_Laminating_AnalisaRollKeRoll
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt_AnalisaLaminasiRollToRoll.RPT")
        End Select
