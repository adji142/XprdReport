...
Public Class frmRPT321_150_Cutting
    ...
    Private Sub FillCombo()
        ...
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.CuttingRoll)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt321151_PenyelesaianWO_Cutting.RPT")
        End Select
