...
Public Class frmRPT321_121_Cutting_AnalisaRollKePcs
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt_321121_AnalisaCuttingRolltoPcs.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt_321122_AnalisaCuttingRolltoPcs.RPT")
        End Select
