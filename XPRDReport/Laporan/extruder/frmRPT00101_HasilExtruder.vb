...
Public Class frmRPT00101_HasilExtruder
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboTipeLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt00101_HasilExtruderByStatus.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt00102_HasilExtruderByStatus.RPT")
        End Select
        ...
        Select Case CboStatusQC.SelectedIndex
            Case 0
                RPTObject.ParameterFields("Status").CurrentValues.AddValue("OK")
            Case 1
                RPTObject.ParameterFields("Status").CurrentValues.AddValue("NON OK")
        End Select
        If CboStatusQC.Text = "-" Then
