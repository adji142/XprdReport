...
Public Class frmRPT110_110_GudangBenang
    ...
    Private Sub FillCombo()
        ...
        cboKodeUnit.ComboBox.DisplayMember = "Nama Lokasi"
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt110111_GudangBenang_V2.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt110112_GudangBenang_V2.RPT")
        End Select
        ...
        RPTObject.ParameterFields("KodeLokasi").CurrentValues.AddValue(cboKodeUnit.ComboBox.SelectedValue)
