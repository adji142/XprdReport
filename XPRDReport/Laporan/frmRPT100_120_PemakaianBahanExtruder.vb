...
Public Class frmRPT100_120_PemakaianBahanExtruder
    ...
    Private Sub FillCombo()
        ...
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.Extruder)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboTipeLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt100121_Extruder.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt100122_Extruder.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt100123_Extruder.RPT")
            Case 4
