...
Public Class frmRPT210_130_GudangRoll
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210131_GudangRoll.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210132_GudangRoll.RPT")
        End Select
        ...
        RPTObject.ParameterFields("KodeKelompok").CurrentValues.AddValue("")
