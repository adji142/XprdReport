...
Public Class frmRPT1300_Extruder
    ...
    Private Sub frmRPTJurnal_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        RPT01.ShowGroupTreeButton = False
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim RPTObject As ReportDocument

        'Report RDO 1301
        '-----------------------------------------------------------------------------------------
        RPTObject = New ReportDocument
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1301_Extruder.RPT")
        ...
        'Informasi
        RPTObject.DataDefinition.FormulaFields("JudulLaporan").Text = "'LAPORAN AFVAL PRODUKSI EXTRUDER'"
        ...
        RPT01.ReportSource = RPTObject
        HideTabControl(RPT01)
        ...
        '-----------------------------------------------------------------------------------------
        RPTObject = New ReportDocument
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1302_Extruder.RPT")
        ...
        RPT02.ReportSource = RPTObject
        HideTabControl(RPT02)
        ...
        '-----------------------------------------------------------------------------------------
        RPTObject = New ReportDocument
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1303_Extruder.RPT")
        ...
        RPT03.ReportSource = RPTObject
        HideTabControl(RPT03)
