...
Public Class frmRPTPemakaianBahanInner
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim DS As DataSet
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.InnerPcs)
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpr_PemakaianBahanInner_VA.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpr_PemakaianBahanInner_VB.RPT")
