...
Public Class frmRPT110_100_GudangBenang
    ...
    Private Sub FillComboMesin()
        ...
        cboMesin.ComboBox.SelectedIndex = cboMesin.ComboBox.Items.Count - 1
    End Sub
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt110101_GudangBenang.RPT")
        End Select
