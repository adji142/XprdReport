...
Public Class frmRPTDowntime_ProExtruder
    Private WithEvents txtTglAwal As New DateTimePicker
    Private WithEvents txtTglAkhir As New DateTimePicker
    Private Sub frmRPTDowntime_ProExtruder_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btRefresh_Click_1(sender As Object, e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt1201_RDO_DowntimeProExtruder.RPT")
        End Select
