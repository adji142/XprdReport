...
Public Class frmRPT410_100_ReturHasilProduksi_
    ...
    Private Sub FillCombo()
        ...
        'Shift Produksi
        Dim DaftarKelHasilProduksi As New DaftarKelompokSerahTerimaHasilProduksi(ActiveSession)

        DS = DaftarKelHasilProduksi.Read("%")
        cboKelompok.ComboBox.DataSource = DS.Tables("View")
        cboKelompok.ComboBox.DisplayMember = "Nama Kelompok"
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt410101_ReturHasilProduksi.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt410102_ReturHasilProduksi.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt410103_ReturHasilProduksi.RPT")
        End Select
        ...
        RPTObject.ParameterFields("Kelompok").CurrentValues.AddValue(cboKelompok.ComboBox.SelectedValue)
