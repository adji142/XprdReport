...
Public Class frmRPT400_100_PenyerahanHasilProduksi
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt400101_PenyerahanHasilProduksi.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt400102_PenyerahanHasilProduksi.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt400103_PenyerahanHasilProduksi.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt400104_PenyerahanHasilProduksi.RPT")
        End Select
        ...
        RPTObject.ParameterFields("Kelompok").CurrentValues.AddValue(cboKelompok.SelectedIndex)
