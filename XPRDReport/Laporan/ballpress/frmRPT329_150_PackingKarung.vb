...
Public Class frmRPT329_150_PackingKarung
    ...
    Private Sub FillCombo()
        ...
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.Ballpress)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt329151_PenyelesaianWO_PackingKarung.RPT")
        End Select
