...
Public Class frmRPT312_110_StockCementBag
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim Loc As New DaftarLokasi(ActiveSession)
        ...
        'Report
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt312111_StockCementBag.RPT")
        ...
        'Parameter
        RPTObject.ParameterFields(0).CurrentValues.AddValue(KodeLokasi)
        RPTObject.ParameterFields(1).CurrentValues.AddValue("193")
