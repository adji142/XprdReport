...
Public Class frmRPT210_100_HasilRoll
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim DS As DataSet
        DS = DaftarLokasiProduksi.Read(XPRDReport.HSP.Data.Lokasi.enumLokasiProduksi.GudangRoll)
        ...
        DS2 = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.Loom)

        If DS2.Tables(0).Rows.Count > 0 Then
            KodeUnit = DS2.Tables(0).Rows(0).Item("Kode")
        End If
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210101_GudangRoll.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210102_GudangRoll.RPT")
            Case 3
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210103_GudangRoll.RPT")
            Case 4
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210104_GudangRoll.RPT")
            Case 5
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210105_GudangRoll.RPT")
            Case 6
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT210106_GudangRoll.RPT")
        End Select
        ...
        RPTObject.ParameterFields("KodeLokasi").CurrentValues.AddValue("")
