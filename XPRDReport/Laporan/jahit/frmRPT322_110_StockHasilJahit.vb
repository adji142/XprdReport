...
Public Class frmRPT322_110_StockHasilJahit
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        'Report
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt322111_StockHasilJahit.RPT")
        ...
        RPTObject.ParameterFields("KELOMPOK").CurrentValues.AddValue("194")
