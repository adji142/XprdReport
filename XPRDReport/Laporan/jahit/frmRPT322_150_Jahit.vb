...
Public Class frmRPT322_150_Jahit
    ...
    Private Sub FillCombo()
        ...
        DS = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.JahitPcs)
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rpt322151_PenyelesaianWO_Jahit.RPT")
        End Select
