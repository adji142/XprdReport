...
Public Class frmRPT320_130_PrintingRoll_AnalisaRollKeRoll
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt_320131_AnalisaPrintingRolltoRoll.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\Rpt_320132_AnalisaPrintingRolltoRoll.RPT")
        End Select
