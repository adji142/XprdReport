...
Public Class frmRPT320_110_StockRollPrinting
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        Dim DSX As DataSet
        DSX = DaftarUnitProduksi.Read("%", UnitProduksi.enumKelompokProduksi.PrintingRoll)
        ...
        Select Case cboLaporan.SelectedIndex + 1
            Case 1
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT320111_StockRollPrinting.RPT")
            Case 2
                RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\RPT320112_StockRollPrinting.RPT")
        End Select
