...
Public Class frmRPT1300_BMF
    ...
    Private Sub btRefresh_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btRefresh.Click
        ...
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1301_BMF.RPT")
        ...
        'Informasi
        RPTObject.DataDefinition.FormulaFields("JudulLaporan").Text = "'LAPORAN AFVAL PRODUKSI BMF'"
        ...
        '-----------------------------------------------------------------------------------------
        RPTObject = New ReportDocument
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1302_BMF.RPT")
        ...
        '-----------------------------------------------------------------------------------------
        RPTObject = New ReportDocument
        RPTObject.Load(System.AppDomain.CurrentDomain.BaseDirectory() + "\Reports\System\rptPro_1303_BMF.RPT")
